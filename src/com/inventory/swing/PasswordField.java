...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getClassLoader().getResource("com/inventory/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getClassLoader().getResource("com/inventory/icon/eye_hide.png")).getImage();

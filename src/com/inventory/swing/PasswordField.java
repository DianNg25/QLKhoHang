...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField()  {
          try {
            eye = ImageIO.read(getClass().getResourceAsStream("/com/inventory/icon/eye.png"));
            eye_hide = ImageIO.read(getClass().getResourceAsStream("/com/inventory/icon/eye_hide.png"));
        } catch (IOException e) {
            throw new RuntimeException("Error loading icons", e);
        }
    ...
    private void createShowHide(Graphics2D g2) {
        if (eye != null && eye_hide != null) {
            ...
            g2.drawImage(hide ? eye_hide : eye, x, y, this);
        } else {
            System.out.println("Icons not loaded");
        }
    }

...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (loginSuccess) {
            this.dispose();
            mainFrame.showAfterSuccessfulLogin();
        } else {
    ...
    private boolean checkLogin(String username, String password) {
        ...
        try {
            ...
            if (rs.next()) {
                isValidUser = true;
                position = rs.getString("Position"); // Fetch the position
                // Fetch and set other employee details to Auth.user
                Auth.user = new Employees(
                        rs.getString("EmployeeID"),
                        rs.getString("Username"),
                        rs.getString("FullName"),
                        rs.getInt("Phone"),
                        rs.getString("Email"),
                        position, // Position from database
                        rs.getString("Image"),

 ...
 * @author Nguyen
 */
public class Model_Update_Suppliers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("SỬA NHÀ CUNG CẤP");
    ...
    private void updateSupplierData() {
        ...
        try {
            ...
            String id = txtSupplierID.getText() != null ? txtSupplierID.getText().trim() : "";
            String name = txtSupplierName.getText() != null ? txtSupplierName.getText().trim() : "";
            ...
            if (!phone.matches("^(0)\\d{9}$")) {
                JOptionPane.showMessageDialog(null, "Số điện thoại không hợp lệ. Nó phải bắt đầu bằng số 0 và có 10 chữ số.");
                return;
            }
            ...
            String checkIdQuery = "SELECT COUNT(*) FROM Suppliers WHERE SupplierID = ?";
            ...
            String query = "UPDATE Suppliers SET SupplierName = ?, Address = ?, Phone = ?, Email = ? WHERE SupplierID = ?";
    ...
    public void setSupplierData(SuppliersTable supplier) {
        ...
        if (supplier == null) {
            ...
            txtPhone.setText(String.valueOf(supplier.getPhone()));
            txtEmail.setText(supplier.getEmail());

            // Nếu bạn có thêm các trường khác liên quan đến nhà cung cấp, hãy đặt chúng ở đây
        }
    }

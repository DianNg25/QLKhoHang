...
public class Model_Add_EnterCoupon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtSoLuongSP = new com.inventory.swing.TextField();
        ...
        txtSoLuongSP.setFocusable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtSoLuongSP, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void cboNhacungCapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboNhacungCapActionPerformed
        ...
        String selectedSupplier = (String) cboNhacungCap.getSelectedItem();
        ...
        if (selectedSupplier != null) {
            try {
                ...
                txtSoLuongSP.setText(String.valueOf(totalQuantity));
    ...
    private void loadSuppliersIntoComboBox() {
        ...
        try {
            ...
            cboNhacungCap.removeAllItems(); // Xóa tất cả các mục hiện tại

            // Thêm từng nhà cung cấp vào JComboBox
            while (rs.next()) {
                cboNhacungCap.addItem(rs.getString("SupplierName"));
            }
    ...
    private com.inventory.swing.TextField txtSoLuongSP;
